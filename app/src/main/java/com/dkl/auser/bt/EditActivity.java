    ...
    private void sendMessage(String message)
    {
        ...
        else
        {
            if (message.length() > 0)
            {
                ...
                Toast.makeText(context , "BLuetooth device is connected." , Toast.LENGTH_SHORT).show();
